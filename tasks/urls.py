...
from tasks.views import dashboard,employee_dashboard,create_task,show_task,delete_task,CreateTask,ViewTask,TaskDetail,UpdateTask,Employee_Dashboard,Delete_Task,ManagerDashboard
urlpatterns = [
