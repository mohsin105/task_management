...
from tasks.views import dashboard,employee_dashboard,manager_dashboard,create_task,show_task,delete_task,task_details,CreateTask,ViewTask,TaskDetail,UpdateTask,Employee_Dashboard
urlpatterns = [
